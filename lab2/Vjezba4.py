...
def on_draw():
    """
         ...
         Ovo je prva verzija programa pa je ovdje navedena inicijalna verzija iscrtavanja koja iscrtava linije.
         ...
         sljedeće transformacije:
                ...
                3. translacija za pomak +/- centriranje -- kako bismo tijelo pomaknuli bliže centru prozora
...
class Tijelo:
    ...
    def citanje_podataka(self, input_file):
        ...
        if self.konveksan:
            print("Vrhovi tijela stavljeni su u raspon [-1, 1], pažljivo odaberi točku!")
    ...
    def provjera_polozaja_tocke(self):
        ...
        Također, prilikom računanja, krajnji rezultat je zaokružen jer bez zaokruživanja, vide se razlike u 5. ili
        manjoj decimali pa nije točan izračun.
        :return:
        """
        x, y, z = self.tocka_V
